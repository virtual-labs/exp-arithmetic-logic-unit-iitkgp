/*Lab:exp_10_Part2_Arithmetic Logic Unit (Arithmetic function)
	File name: arithmeticnote1_exp10p2.js
    ...
    function ledchngarth(){
      ...
      var    s3 = document.getElementById('b3'); /* S3 */
       ...
       var gnd = document.getElementById('b16'); /* GND */
        ...
        if ((s0.src.match("red")) &&  (s1.src.match("red")) && (s2.src.match("red")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red"))){
            ...
            decimal ="0";
             ...
             document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A minus 1";
             ...
             decA_minus1();
           ...
           else if ((s0.src.match("green")) &&  (s1.src.match("red")) && (s2.src.match("red")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
               ...
               decimal ="1";
                ...
                equalu="AB minus 1";
                document.getElementById('add').style.visibility='visible';
                document.getElementById('equationd').innerHTML="Equation for Arithemtic function: AB minus 1";
            //cn="1";
               // alert("cn" +cn);
               generate4bitbinaryalu();
               decAB_minus1();
            ...
            else if ((s0.src.match("red")) &&  (s1.src.match("green")) && (s2.src.match("red")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="2";
                 ...
                 equalu="AB\u0305 minus 1";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function:AB\u0305 minus 1";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                 decABbar_minus1();
            ...
            else if ((s0.src.match("green")) &&  (s1.src.match("green")) && (s2.src.match("red")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                 ...
                 decimal ="3";
                  ...
                  equalu="minus 1";
                  document.getElementById('add').style.visibility='visible';
                  document.getElementById('equationd').innerHTML="Equation for Arithemtic function:  minus 1";
              //cn="1";
                 // alert("cn" +cn);
                 generate4bitbinaryalu();
                  minus1();
              }
              else if ((s0.src.match("red")) &&  (s1.src.match("red")) && (s2.src.match("green")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="4";
                 ...
                 equalu=" A plus (A+B\u0305)";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A plus (A+B\u0305)";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                 decA_plus_decAorBbar();
             }
        
             else if ((s0.src.match("green")) &&  (s1.src.match("red")) && (s2.src.match("green")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="5";
                 ...
                 equalu=" AB plus (A+B\u0305)";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: AB plus (A+B\u0305)";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decAB_plus_decAorBbar();
             }
        
             else if ((s0.src.match("red")) &&  (s1.src.match("green")) && (s2.src.match("green")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                
                decimal ="6";
                 inpS03="0110".split("");
                 mmcn ="0 0 0".split(" ") ;
                 equalu=" A minus B minus 1";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A minus B minus 1";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
             ...
             else if ((s0.src.match("green")) &&  (s1.src.match("green")) && (s2.src.match("green")) && (s3.src.match("red")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="7";
                 ...
                 equalu=" A+B\u0305";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A+B\u0305";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decAor_decBbar();
             ...
             else if ((s0.src.match("red")) &&  (s1.src.match("red")) && (s2.src.match("red")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="8";
                 ...
                 equalu=" A plus (A+B)";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function:A plus (A+B)";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decA_plus_decAorB();
             ...
             else if ((s0.src.match("green")) &&  (s1.src.match("red")) && (s2.src.match("red")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="9";
                 ...
                 equalu=" A plus B";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A plus B";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decA_plus_decB();
             ...
             else if ((s0.src.match("red")) &&  (s1.src.match("green")) && (s2.src.match("red")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="10";
                 ...
                 equalu=" AB\u0305 plus (A+B)";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: AB\u0305 plus (A+B)";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decABbar_plus_decAorB();
             }
        
             else if ((s0.src.match("green")) &&  (s1.src.match("green")) && (s2.src.match("red")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="11";
                 ...
                 equalu=" A+B";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A +B";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decA_or_decB();
             ...
             else if ((s0.src.match("red")) &&  (s1.src.match("red")) && (s2.src.match("green")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                
                decimal ="12";
                 inpS03="1100".split("");
                 mmcn ="0 0 0".split(" ") ;
                 equalu=" A plus A (Note 1)";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function:A plus A (Note 1)";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decA_plus_decA();
             ...
             else if ((s0.src.match("green")) &&  (s1.src.match("red")) && (s2.src.match("green")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="13";
                 ...
                 equalu=" AB plus A";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: AB plus A";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decAB_plus_decA();
             ...
             else if ((s0.src.match("red")) &&  (s1.src.match("green")) && (s2.src.match("green")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="14";
                 ...
                 equalu=" AB\u0305 minus A";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function:AB\u0305 minus A";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decABbar_minus_decA();
             }
             else if ((s0.src.match("green")) &&  (s1.src.match("green")) && (s2.src.match("green")) && (s3.src.match("green")) && (vcc.src.match("green") ) && (m.src.match("red") ) && (cn.src.match("red") )){
                ...
                decimal ="15";
                 ...
                 equalu=" A";
                 document.getElementById('add').style.visibility='visible';
                 document.getElementById('equationd').innerHTML="Equation for Arithemtic function: A";
             //cn="1";
                // alert("cn" +cn);
                generate4bitbinaryalu();
                decA();
...
/* 0 A minus 1 S3=0 S2=0 S1=0 S0=0 cn=0 M=0*/
function decA_minus1(){
    dec_sum=dec_valueAinp-1;
     convertToBinary(dec_sum);
}

/* 1 AB minus 1 S3=0 S2=0 S1=0 S0=1 cn=0 M=0*/
function decAB_minus1(){
    dec_sum=(dec_valueAinp & dec_valueBinp) -1;
    convertToBinary(dec_sum);

}
/* 2 AB'minus 1 S3=0 S2=0 S1=1 S0=0 cn=0 M=0*/
function decABbar_minus1(){
    dec_sum=(dec_valueAinp & dec_valuenotBinp) -1;
    convertToBinary(dec_sum);

}
/* 3 -1 S3=0 S2=0 S1=1 S0=1 cn=0 M=0*/
function minus1(){

    dec_sum=-1;
    convertToBinary(dec_sum);
}
/* 4 A plus (A+B') S3=0 S2=1 S1=0 S0=0 cn=0 M=0*/
function  decA_plus_decAorBbar(){
    dec_sum= (dec_valueAinp + (dec_valueAinp | dec_valuenotBinp));
    //alert("dec_sum" +dec_sum);
    convertToBinary(dec_sum);
}

/* 5 (AB)plus (A+B') S3=0 S2=1 S1=0 S0=1 cn=0 M=0*/
function decAB_plus_decAorBbar(){
    dec_sum=( (dec_valueAinp & dec_valueBinp) + (dec_valueAinp | dec_valuenotBinp));
    convertToBinary(dec_sum);

}
/* 6 A minus B minus 1 S3=0 S2=1 S1=1 S0=0 cn=0 M=0*/
function  decA_minus_decB_minus1(){
    dec_sum=dec_valueAinp - dec_valueBinp -1;
    convertToBinary(dec_sum);

}
/* 7 A+B' S3=0 S2=1 S1=1 S0=1 cn=1 M=0*/
function  decAor_decBbar(){

    dec_sum=(dec_valueAinp | dec_valuenotBinp) ;
    convertToBinary(dec_sum);

}
/* 8 A plus (A+B) S3=1 S2=0 S1=0 S0=0 cn=0 M=0*/
function decA_plus_decAorB(){
...
/* 9 A plus B S3=1 S2=0 S1=0 S0=1 cn=0 M=0*/
 function decA_plus_decB(){
    dec_sum=dec_valueAinp + dec_valueBinp;
    convertToBinary(dec_sum);
 }
/* 10 AB' plus (A+B) S3=1 S2=0 S1=1 S0=0 cn=0 M=0*/
 function decABbar_plus_decAorB(){

    dec_sum=(dec_valueAinp & dec_valuenotBinp) + (dec_valueAinp | dec_valueBinp);
    convertToBinary(dec_sum);
 }
/* 11 A +B  S3=1 S2=0 S1=1 S0=1 cn=0 M=0*/
  function decA_or_decB(){

    dec_sum=(dec_valueAinp | dec_valueBinp);
    convertToBinary(dec_sum);
  }
/* 12 A plus A NOTE1 S3=1 S2=1 S1=0 S0=0 cn=0 M=0*/
  function decA_plus_decA(){
    dec_sum= dec_valueAinp +dec_valueAinp;
   convertToBinary(dec_sum);
}
/* 13 AB plus A S3=1 S2=1 S1=0 S0=1 cn=0 M=0*/
function decAB_plus_decA(){
    dec_sum= (dec_valueAinp & dec_valueBinp) +dec_valueAinp ;
 convertToBinary(dec_sum);
}

/* 14 AB' minus A S3=1 S2=1 S1=1 S0=0 cn=0 M=0*/
function decABbar_minus_decA(){
    dec_sum= (dec_valueAinp & dec_valuenotBinp) -dec_valueAinp ;
    convertToBinary(dec_sum);

}
/* 15 A  S3=1 S2=1 S1=1 S0=1 cn=0 M=0*/
function decA(){
